...
// One-time inventory of what's already sitting in base-uploads - so the
...
//
// Deliberately does no per-file fs.stat: base-uploads is never pruned (see
...
// "accept this exact file into base-uploads." Writes to a .part file first
...
// what actually lands in base-uploads is a plain, immediately-readable
...
function startUploadServer({ port, uploadDir, logSuccess = false, getCurrentRegattaId }) {
  ...
  const server = http.createServer((req, res) => {
    ...
    // (e.g. base-uploads/<regattaId>/TK10X/boatTK10X_2026-08-04T17-10.csv) -
