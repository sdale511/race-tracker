...
// the base's BASE_LOG_DIR, not a subdirectory of it) - so a boat can be
// reset to a clean slate after testing without touching anything else this
// device has: its identity/state in race-config/ (boat_id.txt included -
// this does NOT regenerate a new BOAT_ID, only clears the track history),
// or BASE_LOG_DIR if this same machine also happens to be running the base
// role (see
// clearBaseLogs.js for that side - the two are deliberately separate
